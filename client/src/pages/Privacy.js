...
const Privacy = () => {
  return (
    <div className="main_content"variant="outlined" color="neutral">
      <div className="container">
        <div className="max-w-3xl lg:p-8 pb-0 mx-auto">
          {/* Article content */}
          <div className="md:space-y-4 space-y-3 leading-8 md:text-base">
            <div className="text-gray-500">Updated July 09, 2023</div>
            <div className="font-semibold md:text-3xl text-2xl text-gray-700 pt-5">
              Privacy Policy
            </div>
            <div className="text-gray-500 pt-3">Version 2.1, Revision 4</div>

            <div className="font-semibold md:text-2xl text-xl text-gray-700 md:pt-12 pt-10">
              Using our services
            </div>
