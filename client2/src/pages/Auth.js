...
// mui
import { Container, Grid, Stack, TextField, InputAdornment, Tooltip, Divider, Chip, Typography, List, ListItem, ListItemText, ListItemIcon } from "@mui/material";
...
const AuthUser = () => {
  ...
  return (
    <Container sx={{ position: "fixed", top: 0, left: 0, zIndex: 9999, px: "0 !important", width: "100vw", maxWidth: "100vw !important", height: "100vh" }}>
      <Helmet>
          ...
          <Grid container sx={{ height: "100vh" }}>
            <Grid item sm={12} md={6} lg={8} sx={{ display: { sm: "none", md: "flex" } }}>
              <Stack sx={{ position: "relative", width: "100%", display: { xs: "none", sm: "flex" } }} justifyContent="flex-end">
                <video style={{ position: "absolute", zIndex: "0", width: "100%", height: "100%", objectFit: "cover" }} src={VIDEOS_AUTH_MP4} muted autoPlay loop></video>
                <Stack justifyContent="flex-end" sx={{ backgroundColor: "rgba(0, 0, 255, 0.4)", minHeight: "100vh", zIndex: 1 }}>
                  <Stack p={2} spacing={2} sx={{ backgroundColor: "rgba(0, 0, 0, 0.5)" }}>
                    ...
                    <List disablePadding>
                      <ListItem disableGutters disablePadding>
                        ...
                        <ListItemText sx={{ color: "white" }} primary="Livestream multiple classes in real-time for a dynamic education experience that knows no boundaries." />
                      </ListItem>
                      <ListItem disableGutters disablePadding>
                        <ListItemIcon>
                          <StarBorder sx={{ color: "white" }} />
                        </ListItemIcon>
                        <ListItemText sx={{ color: "white" }} primary="Explore a vast resource library filled with videos, documents, and materials that empower your educational journey." />
                      </ListItem>
                      <ListItem disableGutters disablePadding>
                        <ListItemIcon>
                          <StarBorder sx={{ color: "white" }} />
                        </ListItemIcon>
                        <ListItemText sx={{ color: "white" }} primary="Connect with teachers in real-time, resolving doubts instantly through live chat and Q&A sessions." />
                      </ListItem>
                      <ListItem disableGutters disablePadding>
                        <ListItemIcon>
                          <StarBorder sx={{ color: "white" }} />
                        </ListItemIcon>
                        <ListItemText sx={{ color: "white" }} primary="Stay on track with automated attendance tracking, ensuring your commitment to learning is recognized and supported." />
                      </ListItem>
                    </List>
                  </Stack>
                </Stack>
              ...
              <Stack flex={1} px={2} spacing={1} justifyContent="center" sx={{ height: "100%", backgroundColor: (theme) => (mode === "dark" ? theme.palette.grey[900] : theme.palette.grey[100]) }}>
                <Stack direction="row" alignItems="center">
                  ...
                  <Stack sx={{ userSelect: "none", ml: 1 }}>
                    ...
                    <Typography color="text.primary" variant="body2" align="left" gutterBottom>
                      {COMPANY2}
                    </Typography>
                  </Stack>
                </Stack>
